# =========================================================
# Differential Expression Analysis: T2D vs IGT (GSE76895)
# Platform: GPL570
# =========================================================
...
# 1. Setup environment
#---------------------------------------------------------
setwd("E:/NN project 502/DEG/dhrubo_DEG/T2D vs IGT")
...
# keep only IGT and T2D samples
pheno <- pheno[!pheno$group %in% c("ND", "T3cD"), ]

write.csv(pheno, "pheno_T2D_IGT_only.csv")
# convert to factor
...
write.csv(deg_results, "T2D_vs_IGT_DEG_results.csv")
