# =========================================================
# Differential Expression Analysis: ND vs IGT (GSE76895)
# Platform: GPL570
# =========================================================
...
# 1. Setup environment
#---------------------------------------------------------
setwd("E:/NN project 502/DEG/dhrubo_DEG/T2D vs ND")
...
# keep only ND and T2D samples
pheno <- pheno[!pheno$group %in% c("IGT", "T3cD"), ]
...
write.csv(deg_results, "T2D_vs_ND_DEG_results.csv")
